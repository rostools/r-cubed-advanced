...
- **sessions**: :pencil2: clarify to make two targets in project work

## 2.2.10 (2025-12-04)

### Refactor

- **sessions**: :recycle: build up results plot fully before filtering
...
- **sessions**: :fire: project is set up more for them, so don't need to do these steps
...
- **sessions**: :pencil2: small edits in building one model during review
- **sessions**: :bug: don't eval chunks with `use_git_ignore()`

## 2.2.1 (2025-12-01)

### Fix

- **sessions**: :pencil2: forgot to include survey button
- **sessions**: :bug: prevent extra solution code from going into code appendix

### Refactor

- **sessions**: :pencil2: clarify some items in the stats modeling session
...
- **pre-workshop**: :bug: `@sec-` got rendered to a list item, fixed
