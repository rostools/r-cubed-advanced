...
section](https://r-cubed-intro.rostools.org/sessions/setup-project) from
the introduction workshop to learn about R Projects and how they help
...
Since we will be using Git a lot for this workshop, do a quick check to
make sure your Git is connected to the project and to RStudio. You
should see the Git tab in one of the panes in RStudio or the Git icon
beside the "Go to" search bar below the menu bar of RStudio. If you
don't see it, try [these
troubleshooting](https://happygitwithr.com/troubleshooting) steps.
...
doing data analysis. You may have heard of or used R Markdown, but you
might not have heard of or used Quarto.
...
1.  Please read over the [R Markdown/Quarto
    ...
    of the introduction workshop. *Don't do the exercises*. If you use R
    Markdown or Quarto already, you can skip this step.
...
#| echo: false
#| purl: true
git_ci("docs/learning.qmd", "Add draft lesson qmd file.")
```
