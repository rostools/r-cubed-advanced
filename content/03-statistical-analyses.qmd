...
<!-- TODO: Update code to use solution chunk settings. -->
...
calculate_estimates <- function(data) {
  ...
  readr::write_csv(model_estimates, here::here("data/model-estimates.csv"))
  output_switch_for_targets(model_estimates, "data/model-estimates.csv")
}
```
...
#' @return A data frame.
#'
calculate_estimates <- function(data, csv_path) {
