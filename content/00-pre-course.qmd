...
11. Read the [Code of Conduct](/appendix/conduct.qmd).
...
```{r file-tree-data-folders, echo=FALSE, comment="", eval=FALSE}
...
you are and what you know. The final pre-course task is to complete a
survey that asks if you've read it and if it matches you.
