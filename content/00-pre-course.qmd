...
gert::git_commit("Add draft lesson Rmd file.")
```
...
#| echo: false
#| purl: true
gert::git_add(c("data-raw/nmr-omics.R", "data/lipidomics.rda", ".gitignore"))
gert::git_commit("Script to process omics data into lipidomics rda.")
```
