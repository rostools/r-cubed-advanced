...
for nor knowledge on how to address. Obstacles, that can be fairly
simple, like not having a shared way of writing code or managing files,
can impede effective collaboration. Or they can be complex, like
...
results after collaborators have worked on a project. These barriers can
even affect projects with just one primary researcher. Ultimately, this
can have consequences for the reliability and reproducibility of
scientific results, especially considering that the measures taken to
address these barriers are often not explicitly shared in the science
output (like a publication).
