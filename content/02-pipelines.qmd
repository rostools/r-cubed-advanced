...
Notice `tar_target()` function used at the end of the script. There are
two main arguments for it `name` and `command`. The way that `{targets}`
works is similar to how you'd write R code to assign the output of a
