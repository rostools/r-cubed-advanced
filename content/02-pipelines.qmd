...
```{r solution-plot-code-as-functions}
#| eval: false
#| code-fold: true
...
readLines(here::here("R/functions.R"))[c(-20, -25)] |>
  append("output_switch_for_targets(plot_output, image_path)", after = 20) |>
  append("output_switch_for_targets(plot_output, image_path)", after = 26) |>
  writeLines(here::here("R/functions.R"))
styler::style_dir()
...
readLines(here::here("_targets.R"))[c(-20)] |>
  append(update_targets_plots, after = -21) |>
  writeLines(here::here("_targets.R"))
targets::tar_visnetwork()
targets::tar_make()
...
targets::tar_read(df_stats_by_metabolite) %>% 
  ...
  knitr::kable(caption = "Descriptive statistics of the metabolites.")
'
readLines(here::here("doc/lesson.Rmd")) |>
  stringr::str_replace("targets::tar_read(df_stats_by_metabolite)", pretty_basic_stats_code) |>
  writeLines(here::here("doc/lesson.Rmd"))
