...
> We want to create a data analysis project that: 1) makes it easier for
> direct contributions from collaborators and others, 2) allows us to
> write processing and analysis steps (as code) in a more explicit and
> ultimately reproducible way, 3) incorporates general-purpose tools
