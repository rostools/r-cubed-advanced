...
> We want to create an data analysis project that: 1) makes it easier
> for direct contributions from collaborators and others, 2) allows us
> to write processing and analysis steps (as code) in a more explicit
> and ultimately reproducible way, 3) incorporates general-purpose tools
> that simplify using (or switching) statistical analysis methods, and
> 4) enables quick dissemination of results by creating a
> project-specific website. All of which will be exemplified through a
> simple analysis of a lipidomics study.
...
can hopefully get a better understanding of how things look like. Right
now, everyone's initial project structure should look like:
