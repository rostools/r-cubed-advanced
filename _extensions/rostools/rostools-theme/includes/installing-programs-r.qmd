...
1.  [R](https://cloud.r-project.org/bin/windows/base/): Any version
    above `r min(samwise::get_allowed_r_versions())`. If you have used R
    before, you can confirm the version by running `R.version.string` in
    the Console.
2.  [RStudio](https://www.rstudio.com/products/rstudio/download/#download):
    Any version above `r samwise::get_allowed_rstudio_versions()[1]`. If
...
1.  [R](https://cloud.r-project.org/bin/macosx/): Any version above
    `r min(samwise::get_allowed_r_versions())`. If you have used R
    before, you can confirm the version by running `R.version.string` in
