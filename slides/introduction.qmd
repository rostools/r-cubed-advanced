...
## Researchers don't know how to collaborate effectively {.smaller}

. . .

-   We don't get training in it, nor do we practice it

. . .

-   Example of group who work on improving their collaboration
    [@Turoman2022]

    -   More work upfront, less work later
    -   Decide on tools and practices that are best for the group

## Reading *others'* code is a necessary way to improve and learn as a more experienced coder

-   If you don't collaborate others *directly* on their code, you aren't
    reading others' code

-   If you aren't doing code reviews, you aren't reading others' code

-   If you aren't reading others' code, you aren't improving
