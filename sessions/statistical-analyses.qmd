...
<!-- TODO: Split session here? Could be a nice review too -->
...
lists[^statistical-analyses-1].

[^statistical-analyses-1]: There is probably a more efficient way of
...
estimate should realistically be somewhere between 0 and 5, usually
less. We will eventually need to troubleshoot this issue, but for now,
let's restrict the x axis to be between -5 and 5.
...
There are many more things we could start investigating based on these
