# Smoother project-based collaboration {#sec-dependencies}
...
perhaps want to---*directly collaborate*[^dependencies-1] much
more with others.

[^dependencies-1]: Here, "directly collaborate" means
