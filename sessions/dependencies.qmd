...
software is required to use for or contribute to your project. This
starts out at the highest level: Are you using R or some other software
for the analysis? Since this is an R workshop, we're assuming the
software will be R! 😜
