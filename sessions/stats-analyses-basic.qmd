...
3.  Identify some data transformation techniques and evaluate which are good
...
Specific "anti"-objectives that we will *not* learn:
...
about the world by quantifying uncertainty from some data.
And we quantify uncertainty by using statistics and statistical models.
...
-   "What is the relationship between a metabolite and type 1 diabetes compared to
...
structure the theoretical model so that we can measure the parameters---the variables like growth, sunlight, and water in the model above---
...
So we have the theoretical model and the type of model to use, now how do
