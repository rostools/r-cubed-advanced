...
## Creating the model engine

Let's switch to working in the `docs/learning.qmd` file to create those
...
{{< var keybind.git >}}. Next, in the `docs/learning.qmd` file, on the
...
start writing the function in the `docs/learning.qmd` (we will later move
...
`pivot_wider()` code) in the `docs/learning.qmd` file.
...
7.  Replace the code in the `docs/learning.qmd` file to make use of the
    new functions.
...
Replacing the code in the `docs/learning.qmd` file to use the function.
