...
only one output. We'll return to designing the flow a bit later in the
session, but we want you to try it yourself now to get some practice
with it, before we actually go through it together.
...
1.  Take 5 minutes to individually brainstorm and sketch out how you
    ...
    pipeline. Try using simple pen and paper, drawing out some boxes and
    arrows connecting them. Review @fig-our-pipeline-design and
    @fig-build-table-flow to remind yourself of how we designed our
    previous targets.

2.  Take 5 minutes with your neighbour share and discuss what you both
    have come up with. Try to come to a common understanding or
    agreement of how the design might be.

3.  Finally, over the last 5 minutes, you all can share some of your
    designs and we can discuss some potential benefits and drawbacks of different designs.
