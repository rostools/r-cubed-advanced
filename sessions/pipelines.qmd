...
When doing analyses on data, you have probably experienced (many)
...
adding these steps to a pipeline that tracks them, you can make
...
not well described, and they often require a fair amount of manual
...
Why aren't these computational data pipelines found in most of the "pipelines" described in research?
Because:
...
get you started. But, notice the `tar_target()` function used at the end of
