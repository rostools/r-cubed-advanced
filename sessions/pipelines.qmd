...
track the actual data file we need to create a pipeline target of the data
file. We can accomplish this by using the argument `format = "file"` inside
the `tar_target()` before loading the data using `{readr}`.
