...
1.  Describe the computational meaning of a pipeline and how pipelines
    are often done in research. Explain why a well-designed pipeline can
    streamline your collaboration, reduce the time spent on analysis,
    make analysis steps explicit and easier to work on, and ultimately
...
Whatever the situation, we inevitably need to re-run our analysis.
...
actual pipelines? This is because:
...
readable, and code-based data analysis. We researchers, as a group, have
a long way to go before we can start realistically implementing data
analysis pipelines.
...
pipeline. But for the final paper and the results to be included, we
...
make it more readable, round the numbers to one digit. To do this, we
