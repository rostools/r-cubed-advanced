...
Before we address that issue though, let's first include the `model`
information. In our case, because we had research questions that
involved both, but not comparing them directly, we can use
...
Neat! Now let's fix this standard error issue. In a real analyses, we
