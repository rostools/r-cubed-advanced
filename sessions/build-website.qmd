...
<!-- TODO: Add section about using `tar_quarto()` for projects -->
...
Actions to build and publish our website for us, including rendering all
the Rcode.
...
({{< var keybind.palette >}}) along with typing the text "terminal". Or,
we can make use of the R's `system()` function:
