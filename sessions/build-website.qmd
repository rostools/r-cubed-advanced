...
`doc/learning.qmd` file from being rendered (since we will use this file
...
#| purl: true
#| eval: false
fs::file_move("doc/learning.qmd", "doc/_learning.qmd")
```
...
to the whole project. Cut and paste that metadata from `doc/learning.qmd`
