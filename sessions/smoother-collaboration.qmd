...
2. Add the `{gitcreds}` package as a workflow dependency. You'll need it for the next item

    ``` r
    use_package("gitcreds", "suggests")
    ```
2.  Read through and complete the tasks in the [Connect to GitHub Guide]().
