...
3.  Go back to `doc/learning.qmd` file in RStudio and run `lintr::lint()`
...
4.  Run `styler::style_file()` using the Command Palette (`Ctrl-Shift-P`
    then type "style file") while inside the `doc/learning.qmd` file. What
...
Let's test it out. While in the `doc/learning.qmd` file, go to the bottom
