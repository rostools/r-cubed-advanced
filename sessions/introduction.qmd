...
-   Follow "function-oriented" workflows, where we use R Markdown
    (`doc/lesson.qmd`) to write and test out code, convert it into a
...
-   Use `doc/lesson.qmd` as an exploring and testing document, like a
    ...
    easily delete everything in the `doc/lesson.qmd` file.
