...
`docs/learning.qmd` file. We will also be **regularly** deleting the
...
But, we know you may want to keep some notes as you work in the
workshop. So we suggest you create a new file called `notes.qmd` or
something similar in the `docs/` folder and either:

-   Write notes in the `docs/learning.qmd` file and then copy them over
    to your `notes.qmd` file when we tell you to delete everything, or
-   Write notes directly in your `docs/notes.qmd` file and keep it open
    while you work in the `docs/learning.qmd` file.
:::
