...
-   Follow "function-oriented" workflows, where we use R Markdown
    (`doc/learning.qmd`) to write and test out code, convert it into a
...
-   Use `doc/learning.qmd` as an exploring and testing document, like a
    ...
    easily delete everything in the `doc/learning.qmd` file.
