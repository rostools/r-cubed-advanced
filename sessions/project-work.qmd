...
4.  All team members pull from GitHub.

5.  *Briefly* look through the downloaded dataset by opening up with
...
6.  As a team, brainstorm, design, and decide on:
...
7.  Once you've decided the above points, design and sketch out a basic
...
8.  Once you have the sketch, split up each set of targets in the
...
9.  To make it easier to collaboratively work together, each team member
