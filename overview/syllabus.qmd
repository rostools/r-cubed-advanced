...
-   [Creating automatic analysis pipelines](/sessions/pipelines-setup.qmd)
-   [Creating automatic analysis pipelines](/sessions/pipelines-outputs.qmd)
...
Broken down into specific objectives, we've designed
the workshop to enable you to do the following in each session:
