...
3.  Run `targets::tar_visnetwork()` using
    {{< var keybind.targets_vis >}} to see what targets are outdated and
...
{{< var keybind.targets_make >}}. Once everything has been built, commit
everything to the Git history.
